...
" Modified:   2022-11-03 11:50-0400
" License:    MIT
...
if &background == 'light'
  ...
  hi Normal ctermbg=234 ctermfg=7 guibg=#161821 guifg=#cccccc
  ...
  hi Cursor ctermbg=7 ctermfg=234 guibg=#cccccc guifg=#161821
  hi CursorLineNr cterm=NONE ctermbg=237 ctermfg=253 guibg=#2a3158 guifg=#cdd1e6
  hi Delimiter ctermfg=7 guifg=#cccccc
  hi DiffAdd ctermbg=29 ctermfg=158 guibg=#45493e guifg=#c4c7b5
  hi DiffChange ctermbg=23 ctermfg=159 guibg=#384851 guifg=#b7c5c8
  hi DiffDelete cterm=NONE ctermbg=95 ctermfg=224 gui=NONE guibg=#53343b guifg=#d2b2b2
  hi DiffText cterm=NONE ctermbg=30 ctermfg=195 gui=NONE guibg=#5b7881 guifg=#cccccc
  ...
  hi Pmenu ctermbg=236 ctermfg=251 guibg=#3d425b guifg=#cccccc
  ...
  hi PmenuThumb ctermbg=251 ctermfg=NONE guibg=#cccccc guifg=NONE
  hi PreProc ctermfg=216 guifg=#e2a478
  hi Question ctermfg=150 guifg=#b4be82
  hi QuickFixLine ctermbg=236 ctermfg=7 guibg=#272c42 guifg=#cccccc
  ...
  hi SpellBad ctermbg=95 ctermfg=7 gui=undercurl guifg=NONE guisp=#e27878
  hi SpellCap ctermbg=24 ctermfg=7 gui=undercurl guifg=NONE guisp=#84a0c6
  hi SpellLocal ctermbg=23 ctermfg=7 gui=undercurl guifg=NONE guisp=#89b8c2
  hi SpellRare ctermbg=97 ctermfg=7 gui=undercurl guifg=NONE guisp=#a093c7
  ...
  hi TabLineSel cterm=NONE ctermbg=234 ctermfg=7 gui=NONE guibg=#161821 guifg=#9e9fa1
  ...
  hi icebergNormalFg ctermfg=7 guifg=#cccccc
  ...
  hi gitmessengerPopupNormal ctermbg=235 ctermfg=7 guibg=#1e2132 guifg=#cccccc
  ...
  hi FloatBorder ctermbg=236 ctermfg=251 guibg=#3d425b guifg=#cccccc
  ...
  hi DiagnosticFloatingHint ctermbg=236 ctermfg=251 guibg=#3d425b guifg=#cccccc
  ...
  if has('nvim')
    ...
    let g:terminal_color_15 = '#dad6d6'
  else
    let g:terminal_ansi_colors = ['#1e2132', '#e27878', '#b4be82', '#e2a478', '#84a0c6', '#a093c7', '#89b8c2', '#cccccc', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#ada0d3', '#95c4ce', '#dad6d6']
  endif
endif
